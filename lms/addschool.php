...
if(isset($_POST['addSchool'])){
  //print_r($_POST);
  // Array ( [boardname] => Mohith [language] => EN [schooltype] => Private [addSchool] => )
  ...
  $query = "INSERT INTO schools (`Board`,`Language`,`School Type`)
  VALUES('$boardname', '$language', '$schooltype')";
